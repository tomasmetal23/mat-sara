const preguntas = [
  {
    ...
    respuestaCorrecta: "img/level3/r1_1.png",
  },
  {
    pregunta: "img/level3/p2.png",
    respuestas: [
      "img/level3/r2_1.png",
      "img/level3/r2_2.png",
      "img/level3/r2_3.png",
    ...
    respuestaCorrecta: "img/level3/r2_1.png",
  },
  {
    pregunta: "img/level3/p3.png",
    respuestas: [
      "img/level3/r3_1.png",
      "img/level3/r3_2.png",
      "img/level3/r3_3.png",
    ...
    respuestaCorrecta: "img/level3/r3_2.png",
  },
  
    {
    pregunta: "img/level3/p4.png",
    respuestas: [
      "img/level3/r4_1.png",
      "img/level3/r4_2.png",
      "img/level3/r4_3.png",
    ...
    respuestaCorrecta: "img/level3/r4_2.png",
  },
  
  {
    pregunta: "img/level3/p5.png",
    respuestas: [
      "img/level3/r5_1.png",
      "img/level3/r5_2.png",
      "img/level3/r5_3.png",
    ...
    respuestaCorrecta: "img/level3/r5_1.png",
  },
];
...
let puntuacionMasAlta3 = localStorage.getItem("puntuacionMasAlta3") || 0;
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const puntuacionMasAlta3Elemento = document.getElementById("puntuacion-alta");
  const siguienteBoton = document.getElementById("siguiente");
  const reiniciarBoton = document.getElementById("reiniciar");

  if (puntuacionMasAlta3Elemento) {
    puntuacionMasAlta3Elemento.textContent = `Puntuación más alta: ${puntuacionMasAlta3}`;
  }
  ...
  function juegoTerminado() {
    ...
    if (puntuacion > puntuacionMasAlta3) {
      puntuacionMasAlta3 = puntuacion;
      localStorage.setItem("puntuacionMasAlta3", puntuacionMasAlta3);
      if (puntuacionMasAlta3Elemento) {
        puntuacionMasAlta3Elemento.textContent = `¡Nueva puntuación más alta!: ${puntuacionMasAlta3}`;
      }
    } else if (puntuacionMasAlta3Elemento) {
      puntuacionMasAlta3Elemento.textContent = `Puntuación más alta: ${puntuacionMasAlta3}`;
    }
  }
