const preguntas = [
  {
    ...
    respuestaCorrecta: "img/level2/r1_1.png",
  },
  {
    pregunta: "img/level2/p2.png",
    respuestas: [
      "img/level2/r2_1.png",
      "img/level2/r2_2.png",
      "img/level2/r2_3.png",
    ...
    respuestaCorrecta: "img/level2/r2_1.png",
  },
  {
    pregunta: "img/level2/p3.png",
    respuestas: [
      "img/level2/r3_1.png",
      "img/level2/r3_2.png",
      "img/level2/r3_3.png",
    ...
    respuestaCorrecta: "img/level2/r3_1.png",
  },
  
    {
    pregunta: "img/level2/p4.png",
    respuestas: [
      "img/level2/r4_1.png",
      "img/level2/r4_2.png",
      "img/level2/r4_3.png",
    ...
    respuestaCorrecta: "img/level2/r4_1.png",
  },
  
  {
    pregunta: "img/level2/p5.png",
    respuestas: [
      "img/level2/r5_1.png",
      "img/level2/r5_2.png",
      "img/level2/r5_3.png",
    ...
    respuestaCorrecta: "img/level2/r5_1.png",
  },
];
...
let puntuacionMasAlta2 = localStorage.getItem("puntuacionMasAlta2") || 0;
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const puntuacionMasAlta2Elemento = document.getElementById("puntuacion-alta");
  const siguienteBoton = document.getElementById("siguiente");
  const reiniciarBoton = document.getElementById("reiniciar");

  if (puntuacionMasAlta2Elemento) {
    puntuacionMasAlta2Elemento.textContent = `Puntuación más alta: ${puntuacionMasAlta2}`;
  }
  ...
  function juegoTerminado() {
    ...
    if (puntuacion > puntuacionMasAlta2) {
      puntuacionMasAlta2 = puntuacion;
      localStorage.setItem("puntuacionMasAlta2", puntuacionMasAlta2);
      if (puntuacionMasAlta2Elemento) {
        puntuacionMasAlta2Elemento.textContent = `¡Nueva puntuación más alta!: ${puntuacionMasAlta2}`;
      }
    } else if (puntuacionMasAlta2Elemento) {
      puntuacionMasAlta2Elemento.textContent = `Puntuación más alta: ${puntuacionMasAlta2}`;
    }
  }
