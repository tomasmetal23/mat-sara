const preguntas = [
  {
    ...
    respuestaCorrecta: "img/level1/r1_1.png",
  },
  {
    pregunta: "img/level1/p2.png",
    respuestas: [
      "img/level1/r2_1.png",
      "img/level1/r2_2.png",
      "img/level1/r2_3.png",
    ...
    respuestaCorrecta: "img/level1/r2_1.png",
  },
  {
    pregunta: "img/level1/p3.png",
    respuestas: [
      "img/level1/r3_1.png",
      "img/level1/r3_2.png",
      "img/level1/r3_3.png",
    ...
    respuestaCorrecta: "img/level1/r3_1.png",
  },
  
    {
    pregunta: "img/level1/p4.png",
    respuestas: [
      "img/level1/r4_1.png",
      "img/level1/r4_2.png",
      "img/level1/r4_3.png",
    ...
    respuestaCorrecta: "img/level1/r4_1.png",
  },
  
  {
    pregunta: "img/level1/p5.png",
    respuestas: [
      "img/level1/r5_1.png",
      "img/level1/r5_2.png",
      "img/level1/r5_3.png",
    ...
    respuestaCorrecta: "img/level1/r5_1.png",
  },
];
...
let puntuacionMasAlta1 = localStorage.getItem("puntuacionMasAlta1") || 0;
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const puntuacionMasAlta1Elemento = document.getElementById("puntuacion-alta");
  const siguienteBoton = document.getElementById("siguiente");
  const reiniciarBoton = document.getElementById("reiniciar");

  if (puntuacionMasAlta1Elemento) {
    puntuacionMasAlta1Elemento.textContent = `Puntuación más alta: ${puntuacionMasAlta1}`;
  }
  ...
  function juegoTerminado() {
    ...
    if (puntuacion > puntuacionMasAlta1) {
      puntuacionMasAlta1 = puntuacion;
      localStorage.setItem("puntuacionMasAlta1", puntuacionMasAlta1);
      if (puntuacionMasAlta1Elemento) {
        puntuacionMasAlta1Elemento.textContent = `¡Nueva puntuación más alta!: ${puntuacionMasAlta1}`;
      }
    } else if (puntuacionMasAlta1Elemento) {
      puntuacionMasAlta1Elemento.textContent = `Puntuación más alta: ${puntuacionMasAlta1}`;
    }
  }
